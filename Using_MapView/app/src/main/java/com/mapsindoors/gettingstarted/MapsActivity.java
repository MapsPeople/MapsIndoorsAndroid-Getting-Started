 ...
 * @see <a href="https://developers.google.com/android/reference/com/google/android/gms/maps/MapView">MapView</a>
 */
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback
{
    ...
    void setupMapControl()
    {
        ...
        mapControl.setGoogleMap( gMap, mapView );
 ...
 */
    ...
    //region EXTRA ACTIVITY EVENTS REQUIRED WHEN USING A MapView
    @Override
